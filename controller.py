...
class ControllerCategoria:
    def cadatraCategoria(self, novaCategoria):
        existe = False
        x = DaoCategoria.ler()
        for i in x:
...
class ControllerCliente:
    ...
    def alterarCliente(self, nomeAlterar, novoNome, novoTelefone, novoCpf, novoEmail, novoEndereco):
        ...
        if len(est) > 0:
            ...
            print('Ocliente que deseja alterar nao existe')
    ...
    def removerCliente(self, nome):
        ...
        if len(est) > 0:
            ...
            print('Ocliente que deseja remover não existe')
            return None
