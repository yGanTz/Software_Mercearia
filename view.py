        ...
        if local == 1:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.cadatraCategoria(categoria)
                elif decidir == 2:
                    categoria = input("Diite a categoria que deseja remover\n")
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    produto = input("Digite o peoduto que deseja cadastrar: \n")

                    cat.remoerProduto(produto)
                elif decidir == 3:
            ...
            while True:
                decidit = int(input("Digite 1 para cadastrar um fornecedor\n"
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cpf = input("Digite o cpf do clinte: \n")
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    funcionario = input("Digite o nome do funcionario que deseja remver: \n")
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    dataTermino = input("Digite a data termino no formato dia/mes/ano: \n")
